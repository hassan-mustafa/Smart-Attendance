...
import 'package:flutter_http_post_request/pages/Student_detailpage.dart';
import 'package:flutter_http_post_request/pages/login_page.dart';
class StudentHome extends StatefulWidget {
  final String serial;
  StudentHome(this.serial);
  _StudentHomeState createState() => _StudentHomeState(serial);
}

class _StudentHomeState extends State<StudentHome> with WidgetsBindingObserver {
  BluetoothState _bluetoothState = BluetoothState.UNKNOWN;
  final String serial;
  _StudentHomeState(this.serial);
  ...
  void _startCameraConnect(BuildContext context, BluetoothDevice server) {
    Navigator.of(context).push(MaterialPageRoute(builder: (context) {
      return StudentDetailPage(server: server,serial: serial);
    }));
  }
}